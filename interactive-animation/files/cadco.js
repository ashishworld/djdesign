...
window.keyshotXR = function(U, v, V, W, pa, D, qa, ra, sa, ta, ua, J, K, X, Y, va, Z, wa, $, xa, aa, ya, za, Aa, Ba, p) {
    ...
    this.ua = function(b, d) {
        return A + a.s + "/" + parseInt(d) + "__" + parseInt(b) + "." +
            xa
    };
    ...
    if (document.createElement("canvas").getContext) {
        ...
        if (a.W) {
            ...
            b += "width: 147px;";
            b += y + "transform-origin: 50% 50%;";
            b += "transform:translate(-17%,418%);";
            b += "visibility: inherit;";
            b += "cursor: pointer;";
            b += "line-height: 12pt;";
            b += "font-size: 12pt;";
            b += "opacity: 0.55;";
            b += "border: 1px solid rgba(0,0,0,0.4);";
            b += "box-shadow: 0 0 4px #222;";
            b += "border-radius: 15px;";
            b += "font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif;";
            b += "padding: 5px 0;";
            b += "background-image: linear-gradient(90deg,#c5c5c5 0%, #ffffff 100%);";
            a.M.setAttribute("style", b);

            // left arrow code start
            a.X = document.createElement("span");
             a.X.setAttribute("style",
                "background-image: url("+A + a.s + "/hint-01.png);     background-color: transparent;     background-repeat: no-repeat;     display: block;     position: absolute;     top: 0;     height: 100%;     width: 42px; background-size: 115px;    padding: 0;     max-width: 60px;background-position: 0 50%;left: 5px;");
            a.M.appendChild(a.X);
            // left arrow code end

            // right arrow code start

             a.X = document.createElement("span");
             a.X.setAttribute("style",
                "background-image: url("+A + a.s + "/hint-01.png);     background-color: transparent;     background-repeat: no-repeat;     display: block;     position: absolute;     top: 0;     height: 100%;     width: 56px;  background-size: 115px;   padding: 0;     max-width: 60px;background-position: -60px 50%;right: 5px;");
            a.M.appendChild(a.X);

            // right arrow code end

            // text span code start

            a.X = document.createElement("span");
            // I ? a.X.setAttribute("src", A + a.s + "/files/xr_hand.gif") : a.X.setAttribute("src", A + a.s + "/files/dragspin.png");
            a.X.setAttribute("style",
                "white-space: pre;position: relative; margin: auto;display: inline-block;width: 37%;vertical-align: middle;");
            a.M.appendChild(a.X);

            a.X = document.createElement("span");
            // I ? a.X.setAttribute("src", A + a.s + "/files/xr_hand.gif") : a.X.setAttribute("src", A + a.s + "/files/dragspin.png");
            a.X.textContent = 'Drag to \r\n';
            a.X.textContent += 'Spin';
            a.X.setAttribute("style",
                "white-space: pre;position: relative; margin: auto;font-size: 10pt;display: inline-block;width: 30%;vertical-align: middle;text-align:center;");
            a.M.appendChild(a.X);
